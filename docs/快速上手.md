...
| 文档 | 用途 |
|------|------|
| [标注规范.md](标注规范.md) | 三类行为的标注标准与框选规则 |
| [X-AnyLabeling操作手册.md](X-AnyLabeling操作手册.md) | 标注工具使用教程 |
| [实验手册.md](实验手册.md) | 实验设计、参数对比、判断标准 |
| [录制操作手册.md](录制操作手册.md) | 多路RTSP摄像头录制 |
| [project_guide.md](project_guide.md) | 项目架构与设计决策（开发者向） |
