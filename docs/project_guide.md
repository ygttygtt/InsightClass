...
| 环境 | 职责 |
|------|------|
| 本机 (`QF_DL`) | 视频整理、数据集构建、质检、离线推理、可视化、实验汇总 |
...
| 文档 | 面向 | 内容 |
|------|------|------|
| [快速上手.md](快速上手.md) | 使用者 | 操作步骤和命令 |
| [标注规范.md](标注规范.md) | 标注者 | 正反例定义、框选规则 |
| [X-AnyLabeling操作手册.md](X-AnyLabeling操作手册.md) | 标注者 | 标注工具使用 |
| [实验手册.md](实验手册.md) | 实验者 | 实验设计与判断标准 |
| [录制操作手册.md](录制操作手册.md) | 录制者 | RTSP 多路录制 |
